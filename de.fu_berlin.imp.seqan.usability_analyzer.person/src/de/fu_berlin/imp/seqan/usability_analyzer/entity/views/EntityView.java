...
import de.fu_berlin.imp.seqan.usability_analyzer.entity.viewer.PersonTableViewer;
...
public class EntityView extends ViewPart implements IDataSourceFilterListener,
	...
	private ISelectionListener postSelectionListener = new ISelectionListener() {
		...
		public void selectionChanged(IWorkbenchPart part, ISelection selection) {
			...
			if (selection instanceof IDocument) {
				IDocument document = (IDocument) selection;
			}
		}
	};
	...
	private void createColumns() {
		...
		this.personTableViewer.createColumn("Earliest Entry", 180)
				.setLabelProvider(new ColumnLabelProvider() {
					...
					public String getText(Object element) {
						Entity person = (Entity) element;
						TimeZoneDate earliestDate = person.getEarliestEntryDate();
