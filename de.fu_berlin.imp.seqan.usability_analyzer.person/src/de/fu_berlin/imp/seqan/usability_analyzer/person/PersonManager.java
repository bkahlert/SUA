...
public class PersonManager {
	private Logger logger = Logger.getLogger(PersonManager.class);
	...
	public PersonManager(DiffFileManager diffFileManager,
		 ...
		 * Diff based
		 */
		List<Person> diffBasedPersons = this.getPersonsDiffBased();
		 ...
		 * Token based
		 */
		List<Person> tokenBasedPersons = this.getPersonsTokenBased();
	...
	private List<Person> buildPersonsDoclogFingerprintBased() {
		List<Person> persons = new ArrayList<Person>();
	...
	private List<Person> getPersonsTokenBased() {
		List<Person> persons = new ArrayList<Person>();
