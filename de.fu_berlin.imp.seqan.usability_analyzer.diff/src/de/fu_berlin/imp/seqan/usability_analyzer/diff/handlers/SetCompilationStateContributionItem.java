package de.fu_berlin.imp.seqan.usability_analyzer.diff.handlers;
...
public class SetCompilationStateContributionItem extends ContributionItem {
	...
	public void fill(Menu menu, int index) {
		...
		final Command setCompilationStateCommand = commandService
				.getCommand("de.fu_berlin.imp.seqan.usability_analyzer.diff.setCompilationState");
				...
				public void widgetSelected(SelectionEvent event) {
					try {
						IParameter viewIdParm = setCompilationStateCommand
								.getParameter("de.fu_berlin.imp.seqan.usability_analyzer.diff.setCompilationState.compiles");
