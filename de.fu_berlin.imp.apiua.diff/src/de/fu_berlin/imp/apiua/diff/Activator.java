...
import de.fu_berlin.imp.apiua.diff.extensionProviders.FileFilterUtil;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "de.fu_berlin.imp.apiua.diff"; //$NON-NLS-1$
	...
	private ILabelProviderFactory labelProviderFactory = new ILabelProviderService.LocatablePathLabelProviderFactory(
			0, DiffLocatorProvider.DIFF_NAMESPACE) {
		@Override
