...
import de.fu_berlin.imp.apiua.core.preferences.SUACorePreferenceInitializer;
...
import de.fu_berlin.imp.apiua.diff.extensionProviders.IFileFilterListener;
...
import de.fu_berlin.imp.apiua.diff.ui.widgets.FileFilterComposite;
import de.fu_berlin.imp.apiua.diff.viewer.DiffContentProvider;
import de.fu_berlin.imp.apiua.diff.viewer.DiffViewer;
import de.fu_berlin.imp.apiua.diff.viewer.filters.DiffFileListsViewerFileFilter;
import de.ralfebert.rcputils.menus.ContextMenu;

public class DiffView extends ViewPart implements IDateRangeListener,
		IFileFilterListener {

	public static final String ID = "de.fu_berlin.imp.apiua.diff.views.DiffView";
